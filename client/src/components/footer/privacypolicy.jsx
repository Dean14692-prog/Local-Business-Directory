    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-800 to-gray-900 text-white p-8 flex flex-col items-center justify-center">
      <div className="bg-white text-gray-800 p-8 rounded-xl shadow-xl max-w-3xl w-full">
        ...
        <div className="space-y-6 text-lg leading-relaxed">
          <p>
            At <span className="font-semibold text-blue-600">(Local Business)</span>, we respect your privacy and are committed to protecting any personal information you share with us.
          </p>
          <p>
          ...
          <p className="text-center mt-6">
            ...
            <a href="mailto:group1@gmail.com" className="text-blue-400 hover:text-blue-600">
              group1@gmail.com
            </a>
          </p>
        </div>
