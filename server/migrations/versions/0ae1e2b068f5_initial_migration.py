...
Revision ID: 0ae1e2b068f5
Revises: 
Create Date: 2025-06-25 16:42:10.700877
...
def upgrade():
    ...
    sa.Column('role', sa.Enum('consumer', 'business_owner', name='user_roles'), nullable=False),
